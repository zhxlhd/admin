...
.expendIcon {
  ...
  background-image: url("../assets/imgs/ztree/zTreeStandard.png");
}
...
.ztree li ul.line {
  background: url('../assets/imgs/ztree/line_conn.gif') 0 0 repeat-y;
}
...
.ztree li span.button {
  ...
  background-attachment: scroll;
  background-image: url("../assets/imgs/ztree/zTreeStandard.png");
  *background-image: url("../assets/imgs/ztree/zTreeStandard.gif")
}
...
/*.ztree li span.button.ico_loading{margin-right:2px; background:url('../assets/imgs/ztree/loading.gif') no-repeat scroll 0 0 transparent; 
        ...
        rootClass () {
          ...
          if (this.root === '0') {
            ...
            strRootClass = this.nodes > 1 && this.model.children && this.nodes !== this.num + 1
              ? 'center_' : (this.num === 0 && this.nodes > 1) || (this.nodes !== this.num + 1) ? 'center_docu' : this.nodes === 1 && this.num !== 0 || (this.nodes === this.num + 1 && this.model.children) ? 'bottom_' : 'bottom_docu'
          }
