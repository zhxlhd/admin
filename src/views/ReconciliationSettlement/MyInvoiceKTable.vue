...
<div>
    ...
    <el-form  size="mini" label-width="130px" :model="searchForm" :label-position="labelPosition">
        <el-col :sm="12" :md="12" :lg="8">
            <el-form-item :label="object['busiEntity'].label" :prop="object['busiEntity'].name">
              <el-select  size="mini" clearable v-model="searchForm.busiEntity">
        ...
        <el-col :sm="12" :md="12" :lg="8">
            <el-form-item :label="object['status'].label" :prop="object['status'].name">
                <dict-selected  v-model="searchForm.status" dictType="myInvoiceStatus" :initValue="searchForm.status"></dict-selected>
            </el-form-item>
        </el-col>
          <el-col :sm="12" :md="12" :lg="8">
          ...
          <el-col :sm="12" :md="12" :lg="8">
            <el-form-item :label="object['invoiceCode'].label" :prop="object['invoiceCode'].name">
             <el-input size="mini" clearable v-model="searchForm.invoiceCode" ></el-input>
            </el-form-item>
          </el-col>

            <el-col :sm="12" :md="12" :lg="8">
            <el-form-item :label="object['type'].label" :prop="object['type'].name">
               <dict-selected  v-model="searchForm.type" dictType="myInvoiceItemType" :initValue="searchForm.type"></dict-selected>
            </el-form-item>
          </el-col>

          <el-col :sm="12" :md="12" :lg="8">
            <el-form-item :label="object['startTime'].label" :prop="object['startTime'].name">
             <el-date-picker size="mini" v-model="searchForm.startTime" type="date" placeholder="选择日期" ></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :sm="12" :md="12" :lg="8">
            <el-form-item :label="object['endTime'].label" :prop="object['endTime'].name">
             <el-date-picker @change="changeDate" size="mini" v-model="searchForm.endTime" type="date" placeholder="选择日期"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :sm="12" :md="12" :lg="8">
  ...
  <Boxer :mate="mate.mateList" :mateSearch="mate.mateSearch" :hasSelected="hasSelected" @action="handleButton" ref="Boxer" :msgBoxButton="msgBoxButton">
    <div slot="main">
      <el-row>
        <el-col :span="24">
          <el-table max-height="300" size="mini" highlight-current-row ref="table" :data="mate.mateList.rows" border @selection-change="handleSelectionChange" @sort-change="sortChange" style="width: 100%;">
              <el-table-column fixed="left" type="selection" width="50" id="tableSel"></el-table-column>
               <el-table-column v-if="col.isBtn" :formatter="col.formatter" v-for="col of mate.mateList.columns" v-bind:key="col.name" :label="col.label" :prop="col.name" :min-width="col.width" :sortable="col.sortable" show-overflow-tooltip>
              ...
              <el-table-column show-overflow-tooltip v-if="col.isShow" :formatter="col.formatter" v-for="col of mate.mateList.columns" v-bind:key="col.name" :label="col.label" :prop="col.name" :min-width="col.width" :sortable="col.sortable" >
              </el-table-column>
              <el-table-column show-overflow-tooltip label="操作" fixed="right" :min-width="actionWidth" v-if="mate.mateList.actions">
                 <template slot-scope="scope">
                <el-popover class="elPopover"
                    size="mini" :min-width="actionWidth" v-bind:key="act.action" v-for="act of mate.mateList.actions" placement="top-start" :title="act.label" width="20" trigger="hover">
...
export default {
  ...
  created () {
    var vm = this
    if (this.mate.localName === 'tms_invoice_head_list') {
      this.hashTitle = '销项发票'
    } else {
      this.hashTitle = '进项发票'
    }
  ...
  methods: {
    ...
    findMyInvoice () {
      ...
      if (this.mate.mateFormerHeader.values.itemType === 0) {
        this.itemType('/purchase/tms/invoice/all/list?itemType=0&nopage=true')
      } else {
        this.itemType('/purchase/tms/invoice/all/list?itemType=1&nopage=true')
      }
    },
    itemType (url) {
      var vm = this
