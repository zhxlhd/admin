    ...
    <el-row>
      <el-form size="mini" :model="form">
          <el-col :sm="6" :md="6" :lg="4">
            <el-form-item>
              <el-select clearable size="mini" @change="changeName" v-model="form['customerName']" placeholder="购方公司">
                <el-option
          ...
          <el-col :sm="6" :md="6" :lg="4">
            <el-form-item :rules="rulesCurrencyCode" :props="form['currencyCode']">
              <el-select clearable size="mini" @change="changeThree" v-model="form['currencyCode']" placeholder="币种">
                <el-option
  ...
  methods: {
    ...
    _getUnitOption () {
      ...
      this.$root.ajaxData('/offices/current/offices', {}, function (data) {
        ...
        if (data.length === 1) {
          vm.form['operationUnit'] = data[0].value
        }
      }, 'GET')
    },
    visibleChange (val) {
