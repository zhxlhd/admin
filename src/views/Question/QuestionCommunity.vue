...
export default {
  ...
  data(){
    return {
      ...
      dialogVisible: false,
      QRCodeImg: '',
      QRCodeUrl: '/question/getQRCode?from=community',
      listUrl: '/question/personel/community/list',
    }
  },
  computed: {
  ...
  methods: {
     ...
     */
    handleExport(){
      let url = `${API_GATEWAY}/question/report/export/community`;
      let methods = 'GET';
      SERVICES.BASE.downTemplateExcel(url, methods, '社区人员流动情况报表');
    },
    getList(){
      let _this = this;
