  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        // 境内/个体商户 填写 交通工具
        if(this.areaType === '境内' || this.areaType === '个体工商户') {
          if(!this.vehicle) {
            Toast.fail('请将基本信息必填项填写完整');
            return;
          }
